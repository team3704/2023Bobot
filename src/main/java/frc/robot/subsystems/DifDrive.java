 ...
 */
public class DifDrive extends RobotDriveBase implements Sendable, AutoCloseable {
  private static int instances;

  private final IMotorController m_leftMotor;
  private final IMotorController m_rightMotor;
   ...
   */
  public DifDrive(IMotorController leftMotor, IMotorController rightMotor) {
  ...
  public void arcadeDrive(double xSpeed, double zRotation, boolean squareInputs) {
    ...
    m_leftMotor.set(ControlMode.PercentOutput, speeds.left * m_maxOutput);
    m_rightMotor.set(ControlMode.PercentOutput, speeds.right * m_maxOutput);
  ...
  public void tankDrive(double leftSpeed, double rightSpeed, boolean squareInputs) {
    ...
    leftSpeed = MathUtil.applyDeadband(leftSpeed, 0.1);
    rightSpeed = MathUtil.applyDeadband(rightSpeed, 0.1);
